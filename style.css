/* ============================================
   CSS VARIABLES & RESET - MONOCHROME THEME
   ============================================ */

:root {
  /* Monochrome Colors - Dark Theme */
...
.achievement-card.special .achievement-content {
  padding: var(--spacing-lg);
  text-align: center;
}

.achievement-card.special h3,
.achievement-card.special p {
  color: black;
}
